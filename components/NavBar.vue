<template>
    <!-- Creating nav bar with Bs classes for item spacing and borders -->
    <b-nav justified class="nav">
        ...
        <NuxtLink to="/MusicNews" exact exact-active-class="active" class="nav-item border-left border-bottom border-white">Music News</NuxtLink>
...
<style scoped>
  /* styling nav items and adding hover effect */
  a {
    color: white;
